...
- Provide a Joomla administrator component with Dashboard, Login Information, Configuration, Tools, and About navigation
...
```text
packages/pkg_loginguard_v0.2.0-alpha.zip
```
...
version: 0.2.0-alpha
tag: v0.2.0-alpha
package: pkg_loginguard_v0.2.0-alpha.zip
```
