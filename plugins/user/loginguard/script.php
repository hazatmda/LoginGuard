...
class PlgUserLoginGuardInstallerScript
{
    ...
    private function addMissingColumns(DatabaseDriver $db): void
    {
        ...
        $columns = [
            ...
            'status' => "ALTER TABLE `#__loginguard_attempts` ADD COLUMN `status` varchar(20) NOT NULL DEFAULT '' AFTER `ip_address`",
            ...
            'client' => "ALTER TABLE `#__loginguard_attempts` ADD COLUMN `client` varchar(50) NOT NULL DEFAULT '' AFTER `attempt_type`",
